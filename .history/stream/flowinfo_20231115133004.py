...
class FlowInfo:
    def __init__(self, id: int, client_nic : str, client_ip : str, server_ip : str, server_port : str, size: int):
        self.id = id
...
class FlowCollection:
    def __init__(self, client_ip : str, server_ip : str, server_port_base : int, 
